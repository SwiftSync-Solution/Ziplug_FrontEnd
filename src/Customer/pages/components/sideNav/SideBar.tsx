...
const NavLink = () => {
  ...
  return (
    <nav className="space-y-4">
      <a href="#" onClick={(event) => handleLinkClick("link1", event)}>
        <Link
          to="/dashboard"
      ...
      <a href="#" onClick={(event) => handleLinkClick("link2", event)}>
        <Link
          to="/place-order"
          className={`flex items-center space-x-2 hover:bg-white hover:text-[#0a1172] hover:rounded p-1 ${
            activeLink === "link2"
      ...
      <a href="#" onClick={(event) => handleLinkClick("link3", event)}>
        <Link
          to="/track-shipment"
          className={`flex items-center space-x-2 hover:bg-white hover:text-[#0a1172] hover:rounded p-1 ${
            activeLink === "link3"
      ...
      <a href="#" onClick={(event) => handleLinkClick("link4", event)}>
        <Link
          to="/help"
          className={`flex items-center space-x-2 hover:bg-white hover:text-[#0a1172] hover:rounded p-1 ${
            activeLink === "link4"
